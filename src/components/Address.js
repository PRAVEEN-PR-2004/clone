          ...
          <Col lg={6} md={6} sm={12} className="secondcol">
            ...
            <Form className="secondcolform mt-5">
              <Form.Group className="mb-4 gtform" controlId="formName">
                <Form.Control className="formcontrol" type="text" placeholder="Name" />
              </Form.Group>
              <Form.Group className="mb-4 gtform" controlId="formCity">
                <Form.Control className="formcontrol" type="text" placeholder="City of Residence" />
              </Form.Group>
              ...
              <Form.Group className="mb-4 gtform" controlId="formPhone">
                <Form.Control className="formcontrol" type="number" placeholder="Phone Number" />
              </Form.Group>
              <Form.Group className="mb-4 gtform" controlId="formCity">
              ...
              <Button style={{width:"60%"}} className="sbtn" type="submit">Submit form</Button>
            </Form>
          </Col>
        </Row>
      </div>
